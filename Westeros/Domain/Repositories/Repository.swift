...
final class LocalFactory: HouseFactory, SeasonFactory {
    ...
    var seasons: [Season] {
        ...
        let _ = Episode(title: "Winter is Comming", issueDate: dateFormatter.date(from: "2011-04-17")!, season: season1, summary: "Summary", directedBy: "Tim Van Patten", writedBy: "David Benioff & D. B. Weiss")
        let _ = Episode(title: "The Kingsroad", issueDate: dateFormatter.date(from: "2011-04-24")!, season: season1, summary: "Summary", directedBy: "Tim Van Patten", writedBy: "David Benioff & D. B. Weiss")
        let _ = Episode(title: "The North Remembers", issueDate: dateFormatter.date(from: "2012-04-01")!, season: season2, summary: "Summary", directedBy: "Alan Taylor", writedBy: "David Benioff & D. B. Weiss")
        let _ = Episode(title: "The Night Lands", issueDate: dateFormatter.date(from: "2012-04-08")!, season: season2, summary: "Summary", directedBy: "Alan Taylor", writedBy: "David Benioff & D. B. Weiss")
        let _ = Episode(title: "Valar Dohaeris", issueDate: dateFormatter.date(from: "2013-03-31")!, season: season3, summary: "Summary", directedBy: "Daniel Minahan", writedBy: "David Benioff & D. B. Weiss")
        let _ = Episode(title: "Dark Wings, Dark Words", issueDate: dateFormatter.date(from: "2013-04-07")!, season: season3, summary: "Summary", directedBy: "Daniel Minahan", writedBy: "Vanessa Taylor")
        let _ = Episode(title: "Two Swords", issueDate: dateFormatter.date(from: "2014-04-06")!, season: season4, summary: "Summary", directedBy: "D. B. Weiss", writedBy: "David Benioff y D. B. Weiss")
        let _ = Episode(title: "The Lion and the Rose", issueDate: dateFormatter.date(from: "2014-04-13")!, season: season4, summary: "Summary", directedBy: "Alex Graves", writedBy: "George R. R. Martin")
        let _ = Episode(title: "The Wars to Come", issueDate: dateFormatter.date(from: "2015-04-12")!, season: season5, summary: "Summary", directedBy: "Michael Slovis", writedBy: "David Benioff & D. B. Weiss")
        let _ = Episode(title: "The House of Black and White", issueDate: dateFormatter.date(from: "2015-04-19")!, season: season5, summary: "Summary", directedBy: "Michael Slovis", writedBy: "David Benioff & D. B. Weiss")
        let _ = Episode(title: "The Red Woman", issueDate: dateFormatter.date(from: "2016-04-24")!, season: season6, summary: "Summary", directedBy: "Jeremy Podeswa", writedBy: "David Benioff & D. B. Weiss")
        let _ = Episode(title: "Home", issueDate: dateFormatter.date(from: "2016-05-01")!, season: season6, summary: "Summary", directedBy: "Jeremy Podeswa", writedBy: "Dave Hill")
        let _ = Episode(title: "Dragonstone", issueDate: dateFormatter.date(from: "2017-06-16")!, season: season7, summary: "Summary", directedBy: "Jeremy Podeswa", writedBy: "David Benioff & D. B. Weiss")
        let _ = Episode(title: "Stormborn", issueDate: dateFormatter.date(from: "2017-06-23")!, season: season7, summary: "Summary", directedBy: "Mark Mylod", writedBy: "Bryan Cogman")
...
//        season7.add(episodes: episode1Season7, episode2Season7)
    ...
    var houses: [House] {
        ...
        _ = Person(name: "Jaime", alias: "El mata reyes", house: lannisterHouse)
